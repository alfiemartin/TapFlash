    ...
    <>
      {showScores && (
        <div className="leaderboards w-full h-full flex-col flex justify-center absolute z-20 bg-gray-700 px-2">
          <div className="card w-full sm:w-3/5 lg:w-2/5 h-4/5 md:h-3/5 bg-pink-700 flex justify-start flex-col mx-auto items-end shadow-2xl rounded-2xl px-2 border-2 overflow-y-auto">
            <button
